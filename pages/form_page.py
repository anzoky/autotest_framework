...
class FormPage(BasePage):
    ...
    @allure.step('Fill out all form fields')
    def fill_form_fields(self):
        ...
        person_info = [person.firstname + ' ' + person.lastname, person.email]
        return person_info
    
    @allure.step('Get the list of results from the filled table')
